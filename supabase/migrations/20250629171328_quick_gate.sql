/*
  # Fix Community Feed Functions
  
  1. Changes
     - Drop and recreate get_post_comments function to fix return type issue
     - Drop and recreate get_feed_posts function to ensure type compatibility
     - Add functions for comment management (add_post_comment, increment_comment_count)
     - Add trigger for decrementing comment count on deletion
...
DROP TRIGGER IF EXISTS tr_decrement_comment_count ON post_comments;
