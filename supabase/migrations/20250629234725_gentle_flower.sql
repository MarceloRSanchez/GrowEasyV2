/*
  # Fix Leaderboard View and Function

  1. New Views
    - `public_leaderboard` - Creates a view that joins user profiles with user stats to show leaderboard data
  
  2. Functions
    - `get_leaderboard` - Returns leaderboard data with pagination
  
  3. Security
    - Grants appropriate permissions for public access
*/

-- First drop any existing view or function to avoid conflicts
